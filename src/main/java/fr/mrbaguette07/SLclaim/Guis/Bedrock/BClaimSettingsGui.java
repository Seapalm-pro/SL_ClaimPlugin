...
public class BClaimSettingsGui {
     ...
     */
    public BClaimSettingsGui(Player player, Claim claim, SLclaim instance) {
    ...
    public boolean checkPermPerm(Player player, String perm) {
    	return instance.getPlayerMain().checkPermPlayer(player, "slclaim.setting."+perm) || player.hasPermission("slclaim.setting.*");
    }
