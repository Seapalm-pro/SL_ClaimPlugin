...
public class ClaimsGui implements InventoryHolder {
     ...
     */
    public ClaimsGui(Player player, int page, String filter, SLclaim instance) {
    ...
    private CompletableFuture<Boolean> loadItems(int page, String filter) {
    	...
    	return CompletableFuture.supplyAsync(() -> {
	        ...
	        // Get claims data (use MongoDB if multi-server is enabled)
	        Map<String, Integer> owners = getOwnersByFilter(filter, instance);
     ...
     * Uses MongoDB data when multi-server is enabled.
     * 
     * @param filter The filter to apply.
     * @param instance The SLclaim instance.
     * @return A map of owners and their claim count.
     */
    private Map<String, Integer> getOwnersByFilter(String filter, SLclaim instance) {
    ...
    /**
     * Get the owners based on the filter using local data only.
     * 
     * @param filter The filter to apply.
     * @param instance The SLclaim instance.
     * @return A map of owners and their claim count.
     */
    private Map<String, Integer> getLocalOwnersByFilter(String filter, SLclaim instance) {
        switch (filter) {
            case "sales":
