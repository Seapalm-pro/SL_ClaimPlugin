...
import fr.mrbaguette07.SLclaim.CScoreboard;
import fr.mrbaguette07.SLclaim.ClaimMain;
import fr.mrbaguette07.SLclaim.SLclaim;
import fr.mrbaguette07.SLclaim.Guis.ChunkConfirmationGui;
import fr.mrbaguette07.SLclaim.Guis.ClaimBansGui;
import fr.mrbaguette07.SLclaim.Guis.ClaimChunksGui;
import fr.mrbaguette07.SLclaim.Guis.ClaimConfirmationGui;
import fr.mrbaguette07.SLclaim.Guis.ClaimSettingsGui;
import fr.mrbaguette07.SLclaim.Guis.Bedrock.BChunkConfirmationGui;
import fr.mrbaguette07.SLclaim.Guis.Bedrock.BClaimBansGui;
import fr.mrbaguette07.SLclaim.Guis.Bedrock.BClaimChunksGui;
import fr.mrbaguette07.SLclaim.Guis.Bedrock.BClaimConfirmationGui;
import fr.mrbaguette07.SLclaim.Guis.Bedrock.BClaimListGui;
import fr.mrbaguette07.SLclaim.Guis.Bedrock.BClaimMainGui;
import fr.mrbaguette07.SLclaim.Guis.Bedrock.BClaimMembersGui;
import fr.mrbaguette07.SLclaim.Guis.Bedrock.BClaimSettingsGui;
...
import fr.mrbaguette07.SLclaim.Guis.ClaimListGui;
import fr.mrbaguette07.SLclaim.Guis.ClaimMembersGui;
import fr.mrbaguette07.SLclaim.Guis.ClaimMainGui;
...
public class ClaimCommand implements CommandExecutor, TabCompleter {
     ...
     */
    public ClaimCommand(SLclaim instance) {
    ...
    public List<String> onTabComplete(CommandSender sender, Command cmd, String alias, String[] args) {
        ...
        if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim")) {
            return Collections.emptyList();
        }
    ...
    private void handleDesc(Player player, String playerName, String[] args) {
        if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.setdesc")) {
        ...
        if (instance.getMain().getClaimsNameFromOwner(playerName).contains(args[1])) {
            ...
            Claim claim = instance.getMain().getClaimByName(args[1], player.getName());
    ...
    private void handleArgThree(Player player, String playerName, CPlayer cPlayer, String[] args) {
    	if (args[0].equalsIgnoreCase("delchunk")) {
        	if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.delchunk")) {
        		player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
            Claim claim = instance.getMain().getClaimByName(args[1], player.getName());
    	...
    	if (args[0].equalsIgnoreCase("merge")) {
            if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.merge")) {
            	player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
            ...
            Claim claim1 = instance.getMain().getClaimByName(args[1], player.getName());
            ...
            if(args[2].equals("*")) {
            	...
            	for(String c : args[2].split(";")) {
            		...
            		claims.add(instance.getMain().getClaimByName(c, player.getName()));
            	}
            } else {
                ...
                Claim claim2 = instance.getMain().getClaimByName(args[2], player.getName());
                claims.add(claim2);
            }
        ...
        if (args[0].equalsIgnoreCase("setname")) {
            if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.setname")) {
            	player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
            if (instance.getMain().getClaimsNameFromOwner(playerName).contains(args[1])) {
    	...
    	if (args[0].equalsIgnoreCase("kick")) {
        	if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.kick")) {
        		player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
        ...
        if (args[0].equalsIgnoreCase("ban")) {
        	if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.ban")) {
        		player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
            if (args[1].equalsIgnoreCase("*")) {
        ...
        if (args[0].equalsIgnoreCase("unban")) {
        	if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.unban")) {
        		player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
            if (args[1].equalsIgnoreCase("*")) {
        ...
        if (args[0].equalsIgnoreCase("add")) {
        	if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.add")) {
        		player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
            if (args[1].equalsIgnoreCase("*")) {
        ...
        if (args[0].equalsIgnoreCase("remove")) {
        	if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.remove")) {
        		player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
            if (args[1].equalsIgnoreCase("*")) {
        ...
        if (args[0].equalsIgnoreCase("owner")) {
        	if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.owner")) {
        		player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
            if (args[1].equalsIgnoreCase("*")) {
    ...
    private void handleArgTwo(Player player, String playerName, CPlayer cPlayer, String[] args) {
    	if (args[0].equalsIgnoreCase("cancelinv")) {
            if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.cancelinv")) {
            	player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
    		if(!instance.getSettings().getBooleanSetting("claim-invitations-system")) {
    	...
    	if (args[0].equalsIgnoreCase("accept")) {
            if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.accept")) {
            	player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
    		if(!instance.getSettings().getBooleanSetting("claim-invitations-system")) {
    	...
    	if (args[0].equalsIgnoreCase("deny")) {
            if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.deny")) {
            	player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
    		if(!instance.getSettings().getBooleanSetting("claim-invitations-system")) {
    	...
    	if (args[0].equalsIgnoreCase("addchunk")) {
        	if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.addchunk")) {
        		player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
        ...
        if (args[0].equalsIgnoreCase("see")) {
            if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.see.others")) {
            	player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
            String world = player.getWorld().getName();
        ...
        if (args[0].equalsIgnoreCase("settings")) {
        	if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.settings")) {
        		player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
            Claim claim = instance.getMain().getClaimByName(args[1], player.getName());
        ...
        if (args[0].equalsIgnoreCase("chunks")) {
        	if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.chunks")) {
        		player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
            Claim claim = instance.getMain().getClaimByName(args[1], player.getName());
        ...
        if (args[0].equalsIgnoreCase("members")) {
        	if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.members")) {
        		player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
            Claim claim = instance.getMain().getClaimByName(args[1], player.getName());
        ...
        if (args[0].equalsIgnoreCase("bans")) {
            if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.bans")) {
            	player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
            Claim claim = instance.getMain().getClaimByName(args[1], player.getName());
        ...
        if (args[0].equalsIgnoreCase("autoaddchunk")) {
        	if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.autoaddchunk")) {
        		player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
            String world = player.getWorld().getName();
        ...
        if (args[0].equalsIgnoreCase("autodelchunk")) {
        	if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.autodelchunk")) {
        		player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
            String world = player.getWorld().getName();
    ...
    private void handleArgOne(Player player, String playerName, CPlayer cPlayer, String[] args) {
    	if (args[0].equalsIgnoreCase("cancel")) {
            if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.cancel")) {
            	player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
            Chunk chunk = player.getLocation().getChunk();
            ...
            if (claim.getSale()) {
            	instance.getMain().delChunkSale(claim)
            		.thenAccept(success -> {
            			if (success) {
            				instance.getBossBars().activateBossBar(claim.getChunks());
            				instance.executeEntitySync(player, () -> player.sendMessage(instance.getLanguage().getMessage("claim-in-sale-cancel").replace("%name%", claim.getName())));
            			} else {
            				instance.executeEntitySync(player, () -> player.sendMessage(instance.getLanguage().getMessage("error")));
            			}
            		})
    	...
    	if (args[0].equalsIgnoreCase("buy")) {
            if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.buy")) {
            	player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
            Chunk chunk = player.getLocation().getChunk();
        ...
        if (args[0].equalsIgnoreCase("fly")) {
            ...
            if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.fly")) {
            	player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
            Chunk chunk = player.getLocation().getChunk();
        ...
        if (args[0].equalsIgnoreCase("autofly")) {
            ...
            if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.autofly")) {
            	player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
        ...
        if (args[0].equalsIgnoreCase("chat")) {
            if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.chat")) {
            	player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
        ...
        if (args[0].equalsIgnoreCase("automap")) {
        	if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.automap")) {
        		player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
            String world = player.getWorld().getName();
        ...
        if (args[0].equalsIgnoreCase("map")) {
            if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.map")) {
            	player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
            String world = player.getWorld().getName();
        ...
        if (args[0].equalsIgnoreCase("autoclaim")) {
        	if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.autoclaim")) {
        		player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
            String world = player.getWorld().getName();
        ...
        if (args[0].equalsIgnoreCase("autounclaim")) {
        	if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.autounclaim")) {
        		player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
            String world = player.getWorld().getName();
        ...
        if (args[0].equalsIgnoreCase("setspawn")) {
        	if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.setspawn")) {
        		player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
            Chunk chunk = player.getLocation().getChunk();
        ...
        if (args[0].equalsIgnoreCase("list")) {
        	if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.list")) {
        		player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
        ...
        if (args[0].equalsIgnoreCase("see")) {
        	if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.see")) {
        		player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
            String world = player.getWorld().getName();
        ...
        try {
        	...
        	if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.radius")) {
        		player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
                return;
            }
        	String world = player.getWorld().getName();
        	...
        	if(commands.contains(args[0].toLowerCase()) && player.hasPermission("slclaim.command.claim."+args[0].toLowerCase())) {
        		instance.getMain().getHelp(player, args[0], "claim");
        	} else {
        		player.sendMessage(instance.getLanguage().getMessage("cmd-no-permission"));
        	}
    ...
    private void handleArgZero(Player player, String playerName, CPlayer cPlayer) {
    	...
    	if(instance.getMain().checkIfClaimExists(chunk)) {
            ...
            if (owner.equals("*")) {
            	...
            	if(instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim.main")) {
                    if(instance.getSettings().getBooleanSetting("floodgate")) {
                    	if(FloodgateApi.getInstance().isFloodgatePlayer(player.getUniqueId())) {
                    		new BClaimMainGui(player,claim,instance);
                    		return;
    	...
    	// Check if multi-server mode is enabled and this is a lobby server
    ...
    private List<String> getPrimaryCompletions(Player player, String partialInput) {
        ...
        for (String command : commands) {
            if (instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim." + command)) {
    ...
    private List<String> getSecondaryCompletions(Player player, String arg, String playerName, Chunk chunk, String partialInput) {
        ...
        if(!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim."+arg)) return completions;
    ...
    private List<String> getTertiaryCompletions(Player player, String arg, String arg1, String playerName, String partialInput) {
        ...
        if(!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.claim."+arg)) return completions;
        Claim claim = instance.getMain().getClaimByName(arg1, player.getName());
        ...
        switch (arg.toLowerCase()) {
            ...
            case "kick":
                ...
                break;
            case "delchunk":
            	claim = main.getClaimByName(arg1, player.getName());
            	if(claim != null) {
     ...
     * @param instance  the instance of SLclaim
     * @return a CompletableFuture containing the set of chunks within the radius
     */
    public static CompletableFuture<Set<Chunk>> getChunksInRadius(Player player, Location center, int radius, SLclaim instance) {
