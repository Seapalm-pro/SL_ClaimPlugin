...
import fr.mrbaguette07.SLclaim.Guis.Bedrock.BUnclaimConfirmationGui;
...
public class UnclaimCommand implements CommandExecutor, TabCompleter {
     ...
     */
    public UnclaimCommand(SLclaim instance) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length == 1) {
        	if (args[0].equals("*")) {
                if (!instance.getPlayerMain().checkPermPlayer(player, "slclaim.command.unclaim.all")) {
