...
public class MultiServerConfig {
    ...
    // Expulsion configuration
    private boolean expulsionTeleportToLobby;
    private String expulsionMessage;
    
    // Random for selecting lobby server
    ...
    public MultiServerConfig() {
        ...
        // Default expulsion config
        this.expulsionTeleportToLobby = false;
        this.expulsionMessage = "&cVous avez été expulsé du claim et transféré au lobby.";
    }
    ...
    public boolean isExpulsionTeleportToLobby() { return expulsionTeleportToLobby; }
    public void setExpulsionTeleportToLobby(boolean expulsionTeleportToLobby) { this.expulsionTeleportToLobby = expulsionTeleportToLobby; }
    
    public String getExpulsionMessage() { return expulsionMessage; }
    public void setExpulsionMessage(String expulsionMessage) { this.expulsionMessage = expulsionMessage; }
    
    /**
     * Gets a random lobby server from the configured list.
     * @return A random lobby server name, or null if no lobby servers are configured
     */
