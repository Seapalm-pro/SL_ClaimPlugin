...
public class RedisManager {
    ...
    public CompletableFuture<Boolean> connect() {
        return CompletableFuture.supplyAsync(() -> {
            try {
                ...
                connected = true;
                instance.info("Connexion Redis établie.");
                ...
                instance.info("§cÉchec de la connexion à Redis : " + e.getMessage());
                e.printStackTrace();
                return false;
            }
        }, executor);
    ...
    public void disconnect() {
        ...
        instance.info("Connexion Redis fermée.");
    }
        ...
        subscriber = new JedisPubSub() {
            ...
            public void onMessage(String channel, String message) {
                try {
                    ...
                    instance.info("§cÉchec de l'analyse du message Redis : " + e.getMessage());
                }
            }
            
            @Override
            public void onSubscribe(String channel, int subscribedChannels) {
                instance.info("Abonné au canal Redis : " + channel);
            }
            
            @Override
            public void onUnsubscribe(String channel, int subscribedChannels) {
                instance.info("Désabonné du canal Redis : " + channel);
            }
        };
