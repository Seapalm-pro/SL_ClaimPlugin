...
public class RedisMessage {
    ...
    public enum MessageType {
        ...
        PLAYER_RTP_PENDING,           // RTP en attente après transfert de serveur
        PLAYER_CLAIM_TP_PENDING,      // Téléportation à un claim en attente après transfert
        
        // Server operations
        SERVER_SYNC_REQUEST,
        SERVER_SYNC_RESPONSE,
        SERVER_HEARTBEAT,        // Nouveau: Heartbeat pour détecter les serveurs en ligne
        SERVER_HEARTBEAT_RESPONSE, // Nouveau: Réponse au heartbeat
        CACHE_INVALIDATE,
