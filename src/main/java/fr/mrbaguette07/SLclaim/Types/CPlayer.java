package fr.mrbaguette07.SLclaim.Types;
...
import fr.mrbaguette07.SLclaim.CPlayerMain;
...
public class CPlayer {
     ...
     * @param instance     Instance of SLclaim.
     */
    public CPlayer(Player player, UUID playerId, Integer claims_count, SLclaim instance) {
        this.player = player;
    ...
    public Integer getMaxClaims() {
        if (player.hasPermission("slclaim.admin")) return 0;
    ...
    public boolean canClaim() {
        if (player.hasPermission("slclaim.admin")) return true;
    ...
    public Double getMultipliedCost() {
        if (player.hasPermission("slclaim.admin")) return 0.0;
        Double cost = getCost();
