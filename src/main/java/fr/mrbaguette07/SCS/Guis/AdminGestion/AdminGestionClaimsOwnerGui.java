package fr.mrbaguette07.SCS.Guis.AdminGestion;
...
public class AdminGestionClaimsOwnerGui implements InventoryHolder {
     ...
     */
    public AdminGestionClaimsOwnerGui(Player player, int page, String filter, String owner, SLclaim instance) {
